...
__all__ = [
    "BRAND_DETAIL_FOOTER_PATH",
    "BRAND_DETAIL_FOOTER_URI",
    "BRAND_DETAIL_HEADER_PATH",
    "BRAND_DETAIL_HEADER_URI",
    "BRAND_HEADER_HTML",
    "BRAND_RENDER_WIDTH",
    "DETAIL_SINGLE_COLUMN_LOCK_CSS",
    "DETAIL_UPLOAD_SEGMENT_MAX_HEIGHT",
    "OPTION_GRID_SECTION_CSS",
    "PRETENDARD_BLACK_FONT_PATH",
    "PRETENDARD_FONT_FACE_CSS",
    "PRETENDARD_MEDIUM_FONT_PATH",
    "WHITE_MARGIN_MAX_PAD",
    "WHITE_MARGIN_PAD_RATIO",
    "WHITE_MARGIN_PIXEL_THRESHOLD",
    "WHITE_MARGIN_ROW_RATIO",
    "WHITE_MARGIN_TRIM_THRESHOLD",
    "_pretendard_font_face_css",
