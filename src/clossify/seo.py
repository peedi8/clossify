...
SEO_MATERIAL_SOURCE_KEYS = (
    "props", "material", "materials", "fabric", "소재",
    "title_ko", "translated_title", "translatedTitle",
    "translated_name", "translatedName",
    "source_title", "raw_title", "title_cn",
    "desc_text", "description_text", "description", "desc",
)
