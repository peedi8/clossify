...
5. **원산지** — content=사용자가 제공한 구체적 국가명. "해외"/"기타" 단독 금지. §12.
6. **KC** — `category_meta.requires_kc(category_id)` 기준. 필요 카테고리면 인증표기, 불필요면 미표기. §8·12.
...
- **고시/법적**: 7필드 채움·원산지=구체 국가명·KC 정합(requires_kc 기반)·claim 존재 → 누락 시 FAIL(과태료 500만 §12).
